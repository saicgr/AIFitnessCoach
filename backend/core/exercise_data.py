...
# =====================================================
# KG → LBS REALISTIC GYM MAPPING
# =====================================================
# Gym-standard conversions that match real-world plate/dumbbell availability.
# A raw 60 kg × 2.205 = 132.3 lbs, but gym-goers know 60 kg = 135 lbs (1 plate/side).
# Sources: Rogue, Eleiko, Rep Fitness plate catalogs; US/metric gym standards.
#
# Covers every 0.5 kg from 0.5 to 50, then every 5 kg up to 260 (6 plates/side).
# For weights not in the dict, find the two nearest keys and round to nearest.
KG_TO_LBS_GYM: Dict[float, float] = {
    ...
    50.0: 110,
    # Barbell landmark totals (bar + plates)
...
# Reverse mapping: lbs → kg (standard gym weights)
LBS_TO_KG_GYM: Dict[float, float] = {
    # Dumbbells / light weights
    2.5: 1,    5: 2.5,    8: 3.5,    10: 4.5,   12: 5.5,
    15: 7,     20: 9,     25: 11,    30: 13.5,  35: 16,
    40: 18,    45: 20,    50: 22.5,  55: 25,    60: 27.5,
    65: 30,    70: 32,    75: 34,    80: 36,    85: 38.5,
    90: 40,    95: 43,    100: 45,   105: 47.5, 110: 50,
    115: 52,   120: 55,
    # Barbell totals
    135: 60,   145: 65,   155: 70,   165: 75,   175: 80,
    185: 85,   195: 90,   200: 90,   205: 93,   210: 95,
    225: 100,  230: 105,  245: 110,  255: 115,  265: 120,
    275: 125,  285: 130,  295: 135,  315: 140,  335: 150,
    355: 160,  365: 165,  375: 170,  385: 175,  405: 180,
    420: 190,  430: 195,  445: 200,  465: 210,  495: 220,
    515: 230,  530: 240,  555: 250,  585: 260,
}
