-- Fix get_feed_for_user: cast u.name (varchar) to text to match RETURNS TABLE declaration
-- Error: 'Returned type character varying does not match expected type text in column 15.'
