-- Migration: Clean exercise names by removing trailing numeric IDs and video metadata
-- Created: 2026-01-19
-- Purpose: Remove trailing numbers and "360 degrees" from exercise names
--          e.g., "Barbell Deadlift 360 Degrees" -> "Barbell Deadlift"
--          while preserving legitimate numbered exercises (e.g., "Gada 360-Degree Swing")
...
COMMENT ON VIEW exercise_library_cleaned IS 'Deduplicated exercise library - removes trailing numbers (video IDs), gender suffixes. Prioritizes entries with video+image, one per exercise with clean Title Case names';
