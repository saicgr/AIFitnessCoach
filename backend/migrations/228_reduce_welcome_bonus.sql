-- Migration 228: Reduce Welcome Bonus
-- Updates the first_login welcome bonus from 500 XP to 250 XP
-- Early adopters (first 100 users) receive 525 XP as a special bonus
--
-- Rationale:
-- - 250 XP is enough for new users to reach level 5 quickly (cumulative 145 XP for level 5)
-- - This creates better progression pacing
-- - First 100 users get a premium 525 XP bonus as a reward for early adoption

-- =====================================================
-- 1. UPDATE WELCOME BONUS VALUE
-- =====================================================
...
-- =====================================================
-- 2. UPDATE PROCESS_DAILY_LOGIN TO HANDLE EARLY ADOPTERS
-- =====================================================
...
Migration 228: Welcome bonus reduced to 250 XP (525 XP for first 100 early adopters)';
