...
INSERT INTO branded_programs (
    ...
    'Sad Day Movement',
    'Compassionate self-care workout when you need kindness most',
    'mood_based',
    'all_levels',
    2,
    4,
...
-- Variant: Sad Day Movement - 1w 3x/wk
...
WHERE bp.name = 'Sad Day Movement'
...
-- Variant: Sad Day Movement - 1w 4x/wk
INSERT INTO program_variants (
    base_program_id,
    intensity_level,
    duration_weeks,
...
-- Variant: Sad Day Movement - 2w 3x/wk
INSERT INTO program_variants (
    base_program_id,
    intensity_level,
    duration_weeks,
...
-- Variant: Sad Day Movement - 2w 4x/wk
INSERT INTO program_variants (
    base_program_id,
    intensity_level,
    duration_weeks,
