...
INSERT INTO food_nutrition_overrides (
    ...
    restaurant_name, default_serving_g, source, variant_names,
    notes, food_category, is_active
) VALUES
    ('steak', 'Steak (Beef, Grilled)', 183.0, 29.2, 0.0, 6.8, 0.0, 0.0,
     NULL, 200, 'usda',
     ARRAY['beef steak', 'grilled steak', 'steak dinner', 'cooked steak',
       'steak piece', 'plain steak', '1 steak',
       'medium steak', 'medium rare steak', 'rare steak', 'well done steak'],
    ...
    ('burger', 'Hamburger (Single Patty, Bun)', 250.0, 14.0, 24.0, 11.0, 1.0, 5.0,
     NULL, 150, 'usda',
     ARRAY['hamburger', 'beef burger', 'plain burger', 'regular burger'],
