-- ============================================================================
-- Batch 14: Italian Restaurant Chains
-- Restaurants: Carrabba's, Buca di Beppo, North Italia, Johnny Carino's, Bravo
...
-- ============================================================================
-- 1. CARRABBA'S ITALIAN GRILL (~217 US locations)
-- Source: carrabbas.com/menu/nutrition, nutritionix.com
-- ============================================================================

-- Chicken Bryan: 680 cal, 52g protein, 8g carbs, 48g fat per 350g
...
-- Chicken Parmesan: 850 cal, 55g protein, 48g carbs, 48g fat per 420g
...
-- Fettuccine Alfredo: 780 cal, 24g protein, 68g carbs, 44g fat per 380g
...
-- Rigatoni Campagnolo: 720 cal, 30g protein, 62g carbs, 38g fat per 380g
...
-- Lasagne: 680 cal, 34g protein, 44g carbs, 40g fat per 350g
...
-- Calamari: 620 cal, 22g protein, 48g carbs, 38g fat per 250g
...
-- Tiramisu: 480 cal, 8g protein, 48g carbs, 28g fat per 180g
...
-- ============================================================================
-- 2. BUCA DI BEPPO (~44 US locations)
-- Source: bucadibeppo.com, nutritionix.com, myfitnesspal.com
-- Family-style portions - nutrition per individual serving
-- ============================================================================

-- Chicken Parmesan (individual): 780 cal, 48g protein, 52g carbs, 40g fat per 400g
...
-- Baked Ziti: 650 cal, 28g protein, 58g carbs, 34g fat per 350g
...
-- Spaghetti & Meatballs (individual): 720 cal, 32g protein, 68g carbs, 34g fat per 400g
...
-- Chicken Marsala: 580 cal, 42g protein, 18g carbs, 38g fat per 350g
...
-- Prosciutto & Burrata: 420 cal, 18g protein, 12g carbs, 34g fat per 200g
...
-- Bruschetta: 280 cal, 6g protein, 28g carbs, 16g fat per 150g
...
-- ============================================================================
-- 3. NORTH ITALIA (~45 US locations)
-- Source: northitalia.com, nutritionix.com, myfitnesspal.com
-- ============================================================================

-- Margherita Pizza: 680 cal, 28g protein, 72g carbs, 30g fat per 320g
...
-- Bolognese: 720 cal, 32g protein, 62g carbs, 36g fat per 380g
...
-- White Truffle Garlic Bread: 480 cal, 12g protein, 42g carbs, 30g fat per 200g
...
-- Italian Chicken (Pollo): 520 cal, 44g protein, 12g carbs, 32g fat per 350g
...
-- Burrata & Prosciutto: 450 cal, 20g protein, 10g carbs, 36g fat per 220g
...
-- Caesar Salad: 380 cal, 12g protein, 18g carbs, 30g fat per 250g
...
-- ============================================================================
-- 4. JOHNNY CARINO'S (~30 US locations)
-- Source: carinos.com, nutritionix.com, fatsecret.com
-- ============================================================================

-- Chicken Scallopini: 680 cal, 45g protein, 32g carbs, 40g fat per 380g
...
-- Baked Rigatoni: 750 cal, 30g protein, 64g carbs, 40g fat per 400g
...
-- Spicy Shrimp & Chicken: 720 cal, 38g protein, 52g carbs, 38g fat per 400g
...
-- Italian Nachos: 880 cal, 32g protein, 58g carbs, 58g fat per 350g
...
-- Meat Lasagna: 680 cal, 34g protein, 42g carbs, 40g fat per 350g
...
-- ============================================================================
-- 5. BRAVO ITALIAN KITCHEN (~35 US locations)
-- Source: bravoitalian.com, nutritionix.com, myfitnesspal.com
-- ============================================================================

-- Chicken Limone: 580 cal, 42g protein, 24g carbs, 34g fat per 350g
...
-- Shrimp Scampi: 620 cal, 28g protein, 48g carbs, 34g fat per 370g
...
-- Flatbread Margherita: 520 cal, 22g protein, 48g carbs, 26g fat per 250g
...
-- Pasta Woozie: 820 cal, 28g protein, 72g carbs, 46g fat per 400g
...
-- Insalata della Casa: 320 cal, 10g protein, 16g carbs, 24g fat per 250g
