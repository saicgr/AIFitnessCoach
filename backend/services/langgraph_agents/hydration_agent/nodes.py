...
def get_hydration_system_prompt(ai_settings: Dict[str, Any] = None, locale: str = "en") -> str:
...
async def hydration_log_node(state: HydrationAgentState) -> Dict[str, Any]:
    ...
    base_system_prompt = get_hydration_system_prompt(ai_settings, locale=state.get("locale") or "en")
