...
COUNTRIES = [
    ...
    ("MF", "Saint Martin", "Saint-Martinoise", "saint_martin"),
    ...
    ("TC", "Turks and Caicos Islands", "Turks and Caicos Islander", "turks_caicos"),
    ...
    ("EH", "Western Sahara", "Sahrawi", "western_sahara"),
    ("VI", "US Virgin Islands", "Virgin Islander", "us_virgin_islands"),
