#!/usr/bin/env python3
"""Run migration 1904 - Add notes column to food_logs."""
import os
...
def run_migration():
    ...
    file_path = migrations_dir / "1904_add_food_log_notes.sql"

    print("Running migration 1904: Add notes column to food_logs...")
    try:
        ...
        with conn.cursor() as cur:
            ...
            if rows:
                ...
                print("  WARNING: 'notes' column not found after migration")
