#!/usr/bin/env python3
"""Run migration 1585 - Add data_source, food_log_id, user_email to food_reports."""
import os
...
def run_migration():
    ...
    file_path = migrations_dir / "1585_food_reports_extra_fields.sql"

    print("Running migration 1585: Add data_source, food_log_id, user_email to food_reports...")
    try:
        ...
        with conn.cursor() as cur:
            cur.execute("""
                ...
                WHERE table_name = 'food_reports'
                  AND column_name IN ('data_source', 'food_log_id', 'user_email')
