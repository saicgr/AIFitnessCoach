#!/usr/bin/env python3
"""
Run migration 185: Add photo_url column to users table

This migration:
1. Adds photo_url column to users table for profile photos
2. Adds index for quick lookups
...
def run_migration(client):
    ...
    migration_path = os.path.join(
        ...
        "migrations",
        "185_add_user_photo_url.sql"
    )

    print(f"\n📄 Reading migration 185: add_user_photo_url")
    ...
    try:
        ...
        print(f"✅ Migration 185 completed!")
        return True
...
def main():
    ...
    if run_migration(client):
        print("\n✅ Migration 185 completed successfully!")
        ...
        print("   - backend/migrations/185_add_user_photo_url.sql")
