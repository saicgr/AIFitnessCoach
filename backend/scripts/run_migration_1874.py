#!/usr/bin/env python3
"""Run migration 1874: Sauna session logging table."""
import os, sys
...
def run_migration():
    ...
    file_path = migrations_dir / "1874_sauna_logs.sql"
    ...
    print(f"\n{'='*60}")
    print(f"Running: 1874_sauna_logs.sql")
    print(f"  Creates sauna_logs table with RLS policies")
    ...
    try:
        ...
        with conn.cursor() as cur:
            cur.execute(sql)
        conn.commit()
        print(f"  SUCCESS - sauna_logs table created")
