#!/usr/bin/env python3
"""Run migration 1875: RLS audit safety net."""
import os, sys
...
def run_migration():
    ...
    file_path = migrations_dir / "1875_rls_audit_safety_net.sql"
    ...
    print(f"\n{'='*60}")
    print(f"Running: 1875_rls_audit_safety_net.sql")
    print(f"  Enables RLS + policies on 6 tables")
    ...
    try:
        ...
        with conn.cursor() as cur:
            cur.execute(sql)
        conn.commit()
        print(f"  SUCCESS - RLS policies applied")
