...
class User(BaseModel):
    ...
    is_support_user: bool = False  # True only for support@zealova.com (cannot be unfriended)
    is_new_user: bool = False  # True on first login - signals to app to show welcome message
    support_friend_added: bool = False  # True when Zealova Support was auto-added as friend
