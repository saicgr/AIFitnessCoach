...
async def initiate_streak_recovery(
    ...
    try:
        ...
        # Previous streak length would come from a store of past streak records,
        # but no streak_history table exists in the schema (Sentry
        # PYTHON-FASTAPI-35: "Could not find the table 'public.streak_history'").
        # Without that store previous_streak stays 0 — the recovery message below
        # degrades gracefully. Reintroduce a real lookup here if that table lands.
