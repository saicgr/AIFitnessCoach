...
router.include_router(buddy.router, tags=["Buddy"])  # /buddy/* — synced workouts via Supabase Realtime
...
# Pre-launch waitlist (marketing site signup → Resend confirmation)
