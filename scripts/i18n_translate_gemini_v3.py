...
5. For very short labels (single word), ALWAYS translate to the {native} equivalent. Do NOT use English loanwords — translate "Video" as the native word for video, "Timer" as the native word for timer, etc. Filipino: use authentic Tagalog ("Bidyo", "Pansukat", "Antas", "Maginoo") not English loanwords. Hindi/Marathi/etc: use script-native equivalents. Words like "Premium", "Beast Mode", "Daily", "Weekly" MUST be translated. Only keep verbatim if it matches an item in rule 3.
