...
5. For very short labels (single word), ALWAYS translate to the {native} equivalent. Words like "Premium", "Beast Mode", "Daily", "Weekly" MUST be translated. Only keep verbatim if it matches an item in rule 3.
