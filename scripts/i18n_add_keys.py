...
KEYS: dict[str, str] = {
    ...
    # 2026-05-25 — Telugu/35-locale localization pass: settings + vacation banner + difficulty + habits + imports landing
    "settingsImportsTitle": "Imports",
    "settingsImportsSubtitle": "Everything you've shared into Zealova",
    "settingsCycleTrackingTitle": "Cycle Tracking",
    "settingsCycleTrackingSubtitle": "Period, fertility & predictions",
    "settingsAboutBrand": "About {appName}",
    "vacationModeBannerActive": "Vacation mode is active",
    "vacationModeBannerPausedUntil": "Notifications are paused until {endDate}.",
    "vacationModeBannerPausedNoEnd": "Notifications are paused. Turn off anytime to resume.",
    "vacationModeBannerScheduled": "Scheduled",
    "vacationModeBannerStartsOn": "Starts {startDate}.",
    "vacationModeBannerOn": "Notifications are on",
    "vacationModeBannerOnSubtitle": "Enable vacation mode below to pause non-critical reminders.",
    "difficultyEasy": "Beginner",
    "difficultyMedium": "Moderate",
    "difficultyHard": "Challenging",
    "difficultyHell": "Hell",
    "habitWorkouts": "Workouts",
    "habitFoodLog": "Food Log",
    "habitWater": "Water",
    # Imports landing screen
    "importsAppBarTitle": "Imports",
    "importsTooltipFormatsLimits": "Supported formats & limits",
    "importsTooltipDone": "Done",
    "importsTooltipSelect": "Select",
    "importsSearchHint": "Search imports…",
    "importsFilterAll": "All",
    "importsFilterAllFormats": "All formats",
    "importsActionDelete": "Delete",
    "importsSelectedCount": "{count} selected",
    "importsEmptyTitle": "Nothing shared yet",
    "importsEmptyBody": "Hit Share anywhere — Photos, YouTube, ChatGPT, a voice memo — and it'll land here automatically.",
    "importsActionOpen": "Open",
    "importsActionRetry": "Retry",
    "importsActionReclassify": "Reclassify",
    "importsSnackRetrying": "Retrying import…",
    "importsSnackRetryFailed": "Couldn't retry — try again later.",
    "importsSnackReclassifyQueued": "Reclassify queued — share the item again to reroute.",
    "importsDeleteConfirmTitle": "Delete {count} imports?",
    "importsDeleteConfirmBody": "The records are removed from your imports history. Imported workouts / recipes / food logs themselves stay.",
    "importsActionCancel": "Cancel",
    "importsRowImportFailed": "Import failed",
    "importsTitleImportedWorkout": "Imported workout",
    "importsTitleImportedRecipe": "Imported recipe",
    "importsTitleImportedMealPlan": "Imported meal plan",
    "importsTitleLoggedMeal": "Logged meal",
    "importsTitleFormCheck": "Form check",
    "importsTitleProgressPhoto": "Progress photo",
    "importsTitleSavedTip": "Saved tip",
    "importsTitleImportDetail": "Import detail",
    "importsDetailFrom": "From: {url}",
    "importsDetailStatus": "Status: {status}",
    "importsDetailDetectedAs": "Detected as: {intent}",
    "importsLimitsTitle": "What you can share",
    "importsLimitsLimitsHeader": "Limits",
    "importsLimitsFooter": "Daily caps are the same for everyone. They keep import quality high and protect against runaway costs.",
    # Imports privacy section (in Privacy & Data)
    "importsPrivacySectionTitle": "Imports",
    "importsPrivacyAlwaysAskTitle": "Always ask before routing",
    "importsPrivacyAlwaysAskSubtitle": "Skip the auto-route countdown — every share opens the chooser.",
    "importsPrivacyClearHistoryTitle": "Clear shared history",
    "importsPrivacyClearHistorySubtitle": "Removes every record from your Imports list. Imported workouts, recipes, and food logs themselves stay.",
    "importsPrivacyClearConfirmTitle": "Clear shared history?",
    "importsPrivacyClearConfirmBody": "Every row in your Imports list is removed. The workouts, recipes, and food logs you imported stay where they are.",
    "importsPrivacyClearAction": "Clear",
    "importsPrivacyClearedSnack": "Shared history cleared.",
    "importsPrivacyClearFailedSnack": "Couldn't clear — try again later.",
}
