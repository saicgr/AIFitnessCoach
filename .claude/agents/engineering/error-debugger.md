---
name: error-debugger
description: Diagnose and fix errors — Render deployment logs, Flutter runtime errors, console output, stack traces, app crashes, API errors (e.g. 500s). Reads logs, identifies root causes, implements fixes across frontend and backend.
model: opus
color: red
allowedTools:
  - Bash
