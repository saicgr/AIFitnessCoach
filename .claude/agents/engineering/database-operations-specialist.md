...
description: Database operations across Supabase, Firebase, ChromaDB, GCP — validate/run migrations, check foreign keys, create indexes, test transactions, add columns, reindex ChromaDB collections, generate/populate/insert/modify data, create views, fix RLS policies, audit Supabase security. Researches real data via web search when populating tables.
model: opus
color: purple
allowedTools:
  - WebSearch
