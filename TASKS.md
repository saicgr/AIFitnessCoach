...
1. Welcome Screen NEdds changed - 
	Need to add screenshots as slides
	Need to add graphs and what they could accomplish in between onboarding
...
-0.01. 
	...
	e. United score to combine strength score/nutrition score
	f. Stats needs work

-0. Yes I can show you what macro factor did, I do not want to blatantly copy it though, the colored ones are RIR,  and they are all autogenerated so quickly guessing no AI and more rules,  So if a user enters like say 40 for RIR1, the next set weoght automatically drops 5 to 35, we do not have this implemented which I really liked.
-1. Add app screenshots in the first page as soon as they open the app
-2. Show them what they get in the next page
...
<!-- NEW FEATURES IN APP -->
	f. Need to find a way to design a full plan including fasting, nuttion meal plans, exercise.
1. Live activity https://pub.dev/packages/live_activities
