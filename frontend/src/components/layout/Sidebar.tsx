...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* Bottom section - user avatar with animation */}
      <motion.div
        className="mt-auto pt-4 border-t border-white/5"
        variants={sidebarItemVariants}
      >
        <motion.div
          className="w-10 h-10 rounded-full bg-gradient-to-br from-accent/30 to-primary/30 flex items-center justify-center cursor-pointer"
