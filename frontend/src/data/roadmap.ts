...
export const ROADMAP_FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    title: 'AI meal plans',
    description:
      'Personalized daily meal plans built from your macros, goals, and food preferences.',
    column: 'planned',
    tags: ['Nutrition', 'AI Coach'],
    votable: true,
    eta: 'Q3 2026',
  ...
  },
  {
    ...
    description: 'Recipe ideas that fit your diet, culture, and eating window.',
    column: 'under_consideration',
    tags: ['Nutrition', 'AI Coach'],
    votable: true,
  },
  ...
  },
  {
    ...
    description: 'See your transformation as a visual timeline across weeks and months.',
    column: 'under_consideration',
    tags: ['Tracking'],
    votable: true,
  },
  {
    slug: 'daily-activity-neat',
    title: 'Daily activity tracking',
    description: 'Non-exercise activity (NEAT) folded into your daily energy picture.',
    column: 'under_consideration',
    tags: ['Tracking'],
    votable: true,
  },
  {
    slug: 'tempo-analysis',
    title: 'Tempo & rep-speed analysis',
    description: 'Track set speed and rep tempo patterns across your workouts.',
    column: 'under_consideration',
    tags: ['Workouts', 'Tracking'],
    votable: true,
  },
  {
    slug: 'work-capacity-trends',
    title: 'Work capacity trends',
    description: 'Monitor total training volume and work capacity over time.',
    column: 'under_consideration',
    tags: ['Tracking'],
    votable: true,
  },
  {
    slug: 'training-density',
    title: 'Training density',
    description: 'More work in less time — track density as a progress metric.',
    column: 'under_consideration',
    tags: ['Workouts', 'Tracking'],
    votable: true,
  },
  {
    slug: 'checkin-streaks',
    title: 'Check-in streaks',
    description: 'Daily check-in streaks to build the habit, not just the workout.',
    column: 'under_consideration',
    tags: ['Tracking'],
    votable: true,
  },
  {
    slug: 'smart-notification-timing',
    title: 'Smart notification timing',
    description: 'AI-timed reminders based on when you actually train.',
    column: 'under_consideration',
    tags: ['AI Coach', 'Platform'],
    votable: true,
  },
  {
    slug: 'wearable-hrv',
    title: 'Wearable HRV integration',
    description: 'Pull heart-rate variability from your wearable into recovery insights.',
    column: 'under_consideration',
    tags: ['Tracking'],
    votable: true,
  },
  {
    ...
    description: 'Auto-check your form from a progress photo, not just a video clip.',
    column: 'under_consideration',
    tags: ['Workouts', 'AI Coach'],
    votable: true,
  },
  {
    slug: 'exercise-science-insights',
    title: 'Exercise science insights',
    description: 'Evidence-based training tips drawn from the research literature.',
    column: 'under_consideration',
    tags: ['AI Coach', 'Workouts'],
    votable: true,
  },
  {
    slug: 'per-exercise-rir',
    title: 'Per-exercise RIR targets',
    description: 'Override the default reps-in-reserve target on individual exercises.',
    column: 'under_consideration',
    tags: ['Workouts'],
    votable: true,
  },
  {
    slug: 'saved-training-locations',
    title: 'Saved training locations',
    description: 'Save the gyms you train at, each with its own equipment list.',
    column: 'under_consideration',
    tags: ['Workouts'],
    votable: true,
  },
  {
    slug: 'gym-location-map',
    title: 'Gym location map',
    description: 'Pick and save the spots you train at from a map view.',
    column: 'under_consideration',
    tags: ['Workouts', 'Platform'],
    votable: true,
  },
  {
    slug: 'senior-mode',
    title: 'Senior mode',
    description: 'A simplified interface with larger text and easier navigation.',
    column: 'under_consideration',
    tags: ['Platform', 'Other'],
    votable: true,
    eta: '2027',
  },
  {
    slug: 'kids-mode',
    title: 'Kids mode',
    description: 'Age-appropriate fitness tracking for younger users.',
    column: 'under_consideration',
    tags: ['Platform', 'Other'],
    votable: true,
    eta: '2027',
