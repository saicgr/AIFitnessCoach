        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="space-y-8 text-[15px] text-[var(--color-text-secondary)] leading-relaxed">
            ...
            <div>
              ...
              <p>
                {BRANDING.appName} is a fitness and wellness application. It is not a medical device and is not intended to diagnose, treat, cure, or prevent any disease or medical condition. {BRANDING.appName} has not been evaluated or approved by any regulatory body as a medical device. The information provided through the Service should not be used as a basis for making medical decisions.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                The AI-generated workout plans, nutrition recommendations, and fitness guidance provided by {BRANDING.appName} are for general informational purposes only. They do not constitute medical advice, professional fitness training, or nutritional counseling. The Service is not a substitute for the advice, diagnosis, or treatment provided by a qualified healthcare professional, certified personal trainer, or registered dietitian.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mb-4">
                While using {BRANDING.appName}, you should pay close attention to how your body responds to exercise. Stop exercising immediately and seek medical attention if you experience any of the following:
              </p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <div>
              ...
              <p>
                Physical exercise carries inherent risks, including but not limited to physical injury, disability, and in rare cases, death. By using {BRANDING.appName}, you voluntarily assume all risks associated with physical activities performed in connection with the Service. You acknowledge that {BRANDING.appName}, its developers, affiliates, and partners are not responsible for any injuries, damages, or adverse health outcomes that may result from following AI-generated workout plans or recommendations.
              </p>
            </div>
