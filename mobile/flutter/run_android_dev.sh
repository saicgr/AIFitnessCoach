...
# Android Dev Build Script for Zealova
...
echo -e "${GREEN}=== Zealova Android DEV Build Script (Local Backend) ===${NC}"
...
DART_DEFINES=("--dart-define=ENV=dev" "--dart-define=REVENUECAT_GOOGLE_KEY=$RC_GOOGLE_KEY")
