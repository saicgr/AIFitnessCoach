                      ...
                      builder: (ctx) => AlertDialog(
                        ...
                        content: Column(
                          ...
                          children: [
                            ...
                            _infoRow('Barbell', defaults.barbell, AppLocalizations.of(context)!.weightIncrementsSheetTotal(state.unit)),
        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              _valueBadge(displayValue, perSide ? AppLocalizations.of(context)!.weightIncrementsSheetSide(state.unit) : state.unit, accent),
              const SizedBox(width: 6),
