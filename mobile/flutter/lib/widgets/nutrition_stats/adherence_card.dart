...
/// Adherence & Consistency card — an overall adherence ring, consistency /
/// logging / weeks-analyzed mini stats, a weekly-adherence mini chart, and an
/// AI recommendation strip.
///
/// Extracted verbatim from the /stats Nutrition tab (the original private
/// `_AdherenceCard` + `_MiniStatRow`) so it can be reused on the Nutrition tab
/// without any visual change. Constructor signature unchanged.
