        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              _HapticsSettingsCard().animate().fadeIn(delay: 55.ms),
              ...
              _AccessibilitySettingsCard().animate().fadeIn(delay: 57.ms),

              const SizedBox(height: 24),

              // Health Connect / Apple Health section
              _SectionHeader(title: 'HEALTH SYNC'),
              const SizedBox(height: 12),

              _HealthConnectSettingsCard().animate().fadeIn(delay: 60.ms),
              ...
              children: HapticLevel.values.map((level) {
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected
                          ? (isDark ? AppColors.cyan.withOpacity(0.2) : AppColorsLight.cyan.withOpacity(0.15))
                          : Colors.transparent,
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(
                        color: isSelected
...
// ─────────────────────────────────────────────────────────────────
// Health Connect / Apple Health Settings Card
// ─────────────────────────────────────────────────────────────────
...
class _HealthConnectSettingsCardState extends ConsumerState<_HealthConnectSettingsCard> {
      ...
      child: Column(
        children: [
          ...
          AnimatedCrossFade(
            ...
            crossFadeState: _isExpanded && syncState.isConnected
                ? CrossFadeState.showSecond
                : CrossFadeState.showFirst,
            duration: const Duration(milliseconds: 200),
          ),
  ...
  void _openHealthConnect() {
    // Use url_launcher or intent to open Health Connect
...
final healthSyncPreferencesProvider = StateNotifierProvider<HealthSyncPreferencesNotifier, HealthSyncPreferences>((ref) {
