...
class _ProgressionPaceScreenState extends ConsumerState<ProgressionPaceScreen> {
  ...
  Widget _buildInfoCard(BuildContext context, bool d, Color tp, Color tm) => Container(padding: const EdgeInsets.all(16), decoration: BoxDecoration(color: AppColors.purple.withOpacity(0.1), borderRadius: BorderRadius.circular(16), border: Border.all(color: AppColors.purple.withOpacity(0.3))), child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [Icon(Icons.trending_up, color: AppColors.purple, size: 24), const SizedBox(width: 12), Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(AppLocalizations.of(context).progressionPaceProgressiveOverload, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: tp)), const SizedBox(height: 4), Text(AppLocalizations.of(context).progressionPaceControlHowQuicklyThe, style: TextStyle(fontSize: 14, color: tm, height: 1.4))]))]));
