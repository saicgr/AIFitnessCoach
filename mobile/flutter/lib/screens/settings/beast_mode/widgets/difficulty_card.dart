                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: TappableCell(
                      ...
                      onTap: () => showSliderDialog(
                        context: context,
                        title: AppLocalizations.of(context)!.difficultyCardVolume2(tier),
                        value: values['volume']!,
                        min: 0.50, max: 1.50, step: 0.05,
                        format: (v) => AppLocalizations.of(context)!.difficultyCardX(v.toStringAsFixed(2)),
                  ...
                  Expanded(
                    ...
                    child: TappableCell(
                      ...
                      onTap: () => showSliderDialog(
                        context: context,
                        title: AppLocalizations.of(context)!.difficultyCardRest2(tier),
                        value: values['rest']!,
                        min: 0.50, max: 1.50, step: 0.05,
                        format: (v) => AppLocalizations.of(context)!.difficultyCardX2(v.toStringAsFixed(2)),
                  ...
                  Expanded(
                    ...
                    child: TappableCell(
                      ...
                      onTap: () => showSliderDialog(
                        context: context,
                        title: AppLocalizations.of(context)!.difficultyCardRpe(tier),
                        value: values['rpe']!,
