    ...
    switch (mode) {
      ...
      case WorkoutCardMode.windDown:
        return _HeroBase(
          ...
          // "See tomorrow's plan" opens the workout detail screen. The prior
          // inline-expansion toggle blew out the fixed-height hero carousel
          // (238px) and the user expected a tap to just show tomorrow's
          // workout, not unfold the whole plan on the card.
          primary: _PrimaryButton(
