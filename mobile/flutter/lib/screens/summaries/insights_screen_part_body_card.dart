        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    AppLocalizations.of(context)!.insightsScreenPartBodyCardWorkoutsMinKcal(summary.workoutsCompleted, summary.workoutsScheduled, summary.totalTimeMinutes, summary.caloriesBurnedEstimate),
                    style: TextStyle(
                      fontSize: 12,
                      color: textMuted,
                    ),
            ...
            Container(
              ...
              child: Text(
                AppLocalizations.of(context)!.insightsScreenPartBodyCardValue(summary.completionRate.toInt()),
                style: TextStyle(
                  fontSize: 13,
                  fontWeight: FontWeight.w700,
                  color: _completionColor(summary.completionRate),
