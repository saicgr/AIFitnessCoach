                ...
                child: Column(
                  children: [
                    ...
                    _FeatureItem(
                      ...
                      title: 'Supersets',
                      subtitle: 'Drag exercises together for combo sets',
                      colors: colors,
                    ),
                    const SizedBox(height: 8),
                    _FeatureItem(
                      ...
                      title: 'Advanced sets',
                      subtitle: 'Track drop sets, warmups & more',
                      colors: colors,
                    ),
                    const SizedBox(height: 8),
                    _FeatureItem(
                      ...
                      title: 'Hell Mode',
                      subtitle: 'Regenerate with max intensity',
                      colors: colors,
                    ),
                    const SizedBox(height: 8),
                    _FeatureItem(
                      ...
                      subtitle: 'Add exercises to your next workout',
                      colors: colors,
                    ),
                    const SizedBox(height: 8),
                    _FeatureItem(
