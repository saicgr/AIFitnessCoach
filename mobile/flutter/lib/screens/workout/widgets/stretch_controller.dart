...
class StretchPhaseScreen extends StatelessWidget {
  final StretchController controller;
  ...
  Widget build(BuildContext context) {
    ...
    final currentStretch = controller.currentExercise;

    return PopScope(
      canPop: false,
      onPopInvokedWithResult: (didPop, result) {
        if (!didPop) controller.skipAll();
      },
      child: Scaffold(
    ...
    return Center(
      child: Column(
        children: [
          ...
          if (currentStretch['description'] != null)
            Text(
              currentStretch['description'] as String,
              style: TextStyle(
                fontSize: 14,
                color: textSecondary,
              ),
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              final stretch = controller.exercises[controller.currentIndex + 1 + index];
              return Container(
