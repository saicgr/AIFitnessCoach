...
class ExerciseDetailsSheetContentState
    extends ConsumerState<ExerciseDetailsSheetContent> {
  ...
  Widget _buildSetupInstructionsList(
    ...
    // shared pattern engine (exercise_instruction_copy.dart).
...
class ProgressionSelectorSheet extends StatefulWidget {
  ...
  const ProgressionSelectorSheet({
  ...
  @override
  State<ProgressionSelectorSheet> createState() => ProgressionSelectorSheetState();
}
