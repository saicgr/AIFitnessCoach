...
class QuickWorkoutConstants {
  ...
  // -----------------------------------------------------------------------
  // Expanded 2026-05-08 (validation harness found 15 names covering all 150
  // workouts — "Full Body Blitz" 25×, "Total Burn Express" 23×). Now ~16
  // names per category for meaningful variety on repeat taps.
  static const Map<String, List<String>> workoutNamePools = {
    'strength': [
      'Quick Strength Blast', 'Express Power Session', 'Rapid Strength Hit',
      'Speed Strength', 'Power Express', 'Iron Express', 'Strength Surge',
      'Compact Power', 'Rapid Iron', 'Steel Express', 'Power Pulse',
      'Strength Sprint', 'Forge Express', 'Lift Quick', 'Iron Edge',
      'Steel Pulse',
    ],
    'cardio': [
      'HIIT Express', 'Quick Cardio Blast', 'Rapid Fire Cardio',
      'Cardio Surge', 'Burn Express', 'Sweat Sprint', 'Pulse Express',
      'Heart Rate Hit', 'Cardio Pulse', 'Conditioning Quick',
      'Endurance Sprint', 'Tempo Express', 'Sweat Storm', 'Burn & Breathe',
      'Engine Express', 'Aerobic Surge',
    ],
    'stretch': [
      'Quick Flexibility Flow', 'Express Mobility', 'Rapid Recovery',
      'Flex Express', 'Stretch & Release', 'Mobility Pulse',
      'Recovery Flow', 'Reset Express', 'Joint Flow', 'Range Express',
      'Limber Up Quick', 'Open Up Flow', 'Unwind Express',
      'Decompression Flow', 'Mobility Reset', 'Flexibility Pulse',
    ],
    'full_body': [
      'Total Body Express', 'Full Body Blitz', 'Complete Quick Hit',
      'Total Burn Express', 'Full Body Surge', 'Complete Pulse',
      'Whole Body Sprint', 'All-Over Express', 'Full Spectrum',
      'Total Pulse', 'Body Surge', 'Express All-In', 'Complete Surge',
      'Full Body Forge', 'All-Body Quick', 'Total Forge',
    ],
    'upper_body': [
      'Upper Body Express', 'Arms & Shoulders Blast', 'Push-Pull Express',
      'Upper Pump', 'Upper Surge', 'Arms Express', 'Chest & Back Quick',
      'Upper Forge', 'Press & Pull', 'Top Half Express', 'Upper Pulse',
      'Shoulder Surge', 'Arm Day Express', 'Upper Power', 'Push Pull Pulse',
      'Upper Edge',
    ],
    'lower_body': [
      'Leg Day Express', 'Lower Body Blast', 'Quick Leg Burn',
      'Glutes & Legs Express', 'Lower Surge', 'Leg Forge', 'Quad Express',
      'Glute Pulse', 'Lower Power', 'Leg Pulse', 'Posterior Express',
      'Hip & Leg Surge', 'Lower Edge', 'Bottom Half Quick',
      'Wheels Express', 'Stride Forge',
    ],
    'core': [
      'Core Crusher Express', 'Ab Blast', 'Core Strength Quick',
      'Midsection Express', 'Core Pulse', 'Trunk Surge', 'Core Forge',
      'Six-Pack Sprint', 'Stability Express', 'Core Power', 'Anti-Rotation',
      'Bracing Express', 'Core Edge', 'Trunk Express', 'Midline Forge',
      'Core Pulse Burst',
    ],
    'emom': [
      'EMOM Express', 'Every Minute Power', 'EMOM Challenge',
      'Minute-by-Minute', 'EMOM Pulse', 'Top of Minute', 'Clock Express',
      'On the Minute', 'Minute Forge', 'EMOM Surge', 'Tick Tock',
      'Beat the Clock', 'Minute Sprint', 'Pulse Per Minute',
      'EMOM Edge', 'Race the Bell',
    ],
    'amrap': [
      'AMRAP Assault', 'Max Rounds Express', 'AMRAP Challenge',
      'Race the Clock', 'AMRAP Pulse', 'Round Surge', 'Endless Loop',
      'AMRAP Forge', 'Rep Storm', 'Round Hunter', 'Max Output',
      'Volume Sprint', 'AMRAP Edge', 'Round Pulse', 'Effort Express',
      'Repetition Race',
    ],
  };
