...
FoodLog _$FoodLogFromJson(Map<String, dynamic> json) => FoodLog(
  ...
  inflammationScore: (json['inflammation_score'] as num?)?.toInt(),
  isUltraProcessed: json['is_ultra_processed'] as bool?,
  glycemicLoad: (json['glycemic_load'] as num?)?.toInt(),
...
Map<String, dynamic> _$FoodLogToJson(FoodLog instance) => <String, dynamic>{
  ...
  'inflammation_score': instance.inflammationScore,
  'is_ultra_processed': instance.isUltraProcessed,
  'glycemic_load': instance.glycemicLoad,
  'fodmap_rating': instance.fodmapRating,
  'fodmap_reason': instance.fodmapReason,
...
Map<String, dynamic> _$LogFoodResponseToJson(LogFoodResponse instance) =>
    <String, dynamic>{
      ...
      'source_type': instance.sourceType,
      'corrected_query': instance.correctedQuery,
      'sodium_mg': instance.sodiumMg,
      'sugar_g': instance.sugarG,
      'saturated_fat_g': instance.saturatedFatG,
      'cholesterol_mg': instance.cholesterolMg,
