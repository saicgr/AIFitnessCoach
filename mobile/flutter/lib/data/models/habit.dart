...
class HabitTemplate {
  ...
  static const List<HabitTemplate> defaults = [
    ...
    HabitTemplate(
      ...
      description: 'Avoid soda, juice, and sweetened coffee',
      category: HabitCategory.nutrition,
    ...
    HabitTemplate(
      id: 'no_outside_food',
      name: 'No Eating Out',
      description: 'Avoid restaurants and takeout',
      category: HabitCategory.nutrition,
      habitType: HabitType.negative,
      icon: 'do_not_disturb',
      color: '#EF4444',
    ...
    HabitTemplate(
      ...
      description: 'Skip DoorDash, UberEats, etc.',
      category: HabitCategory.nutrition,
      habitType: HabitType.negative,
      icon: 'do_not_disturb',
      color: '#F43F5E',
    ...
    HabitTemplate(
      id: 'log_food',
      name: 'Log All Meals',
      description: 'Track everything you eat today',
      category: HabitCategory.nutrition,
      icon: 'edit_note',
      color: '#06B6D4',
    ),
    ...
    HabitTemplate(
      ...
      description: 'Foam roll, yoga, or light movement on rest days',
      category: HabitCategory.activity,
      icon: 'self_improvement',
      color: '#A855F7',
    ),
    HabitTemplate(
      id: 'cardio',
      name: 'Cardio Session',
      description: 'Run, bike, swim, or any cardio',
      category: HabitCategory.activity,
      icon: 'directions_run',
      color: '#F43F5E',
      suggestedTargetCount: 30,
    ...
    HabitTemplate(
      id: 'neat',
      name: 'Stay Active (NEAT)',
      description: 'Take stairs, stand up, move often',
      category: HabitCategory.activity,
      icon: 'directions_walk',
      color: '#22C55E',
    ),
    ...
    HabitTemplate(
      id: 'sleep_early',
      name: 'Sleep Early',
      description: 'In bed by your target bedtime',
    ...
    HabitTemplate(
      ...
      description: 'Get 10 min of sunlight after waking',
      category: HabitCategory.health,
      icon: 'wb_sunny',
      color: '#FBBF24',
      suggestedTargetCount: 10,
    ...
    HabitTemplate(
      id: 'meditate',
      name: 'Meditate',
      description: 'Practice mindfulness or breathing',
      category: HabitCategory.health,
      icon: 'spa',
      color: '#14B8A6',
      suggestedTargetCount: 10,
    ...
    HabitTemplate(
      id: 'cold_shower',
      name: 'Cold Shower',
      description: 'End with 30-60 seconds of cold water',
      category: HabitCategory.health,
      icon: 'water_drop',
      color: '#0EA5E9',
    ),
    ...
    HabitTemplate(
      id: 'no_smoking',
      name: 'No Smoking/Vaping',
      description: 'Stay smoke and vape free',
      category: HabitCategory.health,
      habitType: HabitType.negative,
      icon: 'do_not_disturb',
      color: '#EF4444',
    ...
    HabitTemplate(
      id: 'weigh_in',
      name: 'Daily Weigh-In',
      description: 'Track your weight each morning',
      category: HabitCategory.health,
      icon: 'star',
      color: '#F97316',
    ),
    ...
    HabitTemplate(
      ...
      description: 'Note 3 things you are grateful for',
      category: HabitCategory.lifestyle,
      icon: 'favorite',
      color: '#EC4899',
    ),
    ...
    HabitTemplate(
      ...
      description: 'Stay off social media or limit to 30 min',
      category: HabitCategory.lifestyle,
      habitType: HabitType.negative,
      icon: 'phone_disabled',
      color: '#6366F1',
    ...
    HabitTemplate(
      id: 'plan_tomorrow',
      name: 'Plan Tomorrow',
      description: 'Write out your schedule and priorities',
      category: HabitCategory.lifestyle,
      icon: 'edit_note',
      color: '#06B6D4',
    ),
