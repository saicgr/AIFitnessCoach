...
class WeeklyRecommendation {
  ...
  factory WeeklyRecommendation.fromJson(Map<String, dynamic> json) {
    return WeeklyRecommendation(
      ...
      recommendedProteinG: (json['recommended_protein_g'] as num).toInt(),
      recommendedCarbsG: (json['recommended_carbs_g'] as num).toInt(),
      recommendedFatG: (json['recommended_fat_g'] as num).toInt(),
