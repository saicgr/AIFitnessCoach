...
class PdfExportService {
  ...
  static String generateTextSummary({
    ...
    buffer.writeln('${Branding.appName} Stats Summary');
    buffer.writeln('=' * 30);
    ...
    buffer.writeln('Generated by ${Branding.appName}');
    buffer.writeln('https://${Branding.marketingDomain}');
