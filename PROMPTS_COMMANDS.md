...
<!-- REVIEW OF OTHER APP -->
<!-- 
Be sure to check if the feature already exists for below request

For other app another user said 
"
For analytics do we have workout bistory per exercise and also per muscle, not sure what the image is sowing like muscle or soemthing else.
" 
...
<!-- Can you do flutter clean, uninstall and reinstall the app? -->
